...
class Lang(Findable):
    ...
    @abstractmethod
    def translateProgram(self, program: Program, include_dirs: Set[Path], defines: List[str], app_consts: List[Const], loop_to_function_name: Dict[str,str], force_soa: bool, offload_pragma_flag_dict = {}) -> str:
        pass
